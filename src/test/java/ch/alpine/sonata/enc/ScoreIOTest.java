...
class ScoreIOTest {
  @Test
  void testMxl() {
    Path file = Unprotect.path("/io/mxl/bwv0525_1.mxl");
  ...
  @Test
  void testSt1() {
    Path file = Unprotect.path("/io/st1/twv0098_2.st1");
    Score score = ScoreIO.read(file);
  ...
  @Test
  void testSt2() {
    Path file = Unprotect.path("/io/st2/twv41a5a_2.st2");
    Score score = ScoreIO.read(file);
  ...
  @Test
  void testKrn1() {
    Path file = Unprotect.path("/io/krn/alv01_05.krn");
    Score score = ScoreIO.read(file);
    assertEquals(score.voices(), 3);
  }
  ...
  @Test
  void testKrn2() {
    Path file = Unprotect.path("/io/krn/bwv978-2.krn");
    Score score = ScoreIO.read(file);
